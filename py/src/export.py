    ...
    def export_onnx(self):
        ...
        with torch.no_grad():
            torch.onnx.export(first_model, dummy_input_first,
                              ...
                              input_names=input_names_first, output_names=output_names_first, opset_version=13)
            torch.onnx.export(second_model, dummy_input_second,
                              f"exported_models/vit_h/sam_vit_h_embedding_second.onnx", verbose=True,
                              input_names=input_names_second, output_names=output_names_second, opset_version=13)
